...
namespace kofola
{
    ...
    private:
        abstract_successor *abstr_succ_; /// instance of abstract_successor that provides states and transitions
        ...
        std::vector<std::pair<std::shared_ptr<abstract_successor::mstate>, spot::acc_cond::mark_t>> dfs_acc_stack_; /// this stack could probably be omitted and use SCCs_ instead

        std::vector<std::shared_ptr<abstract_successor::mstate>> empty_lang_states_; /// stores states from non-trivial SCCs with empty language
